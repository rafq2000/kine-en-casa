...
export const metadata: Metadata = {
    ...
    description: `Kinesiólogo a domicilio en Macul. Rehabilitación traumatológica, respiratoria infantil, geriátrica y post quirúrgica. Reembolso Isapre. Evaluación gratis.`,
    keywords: [
