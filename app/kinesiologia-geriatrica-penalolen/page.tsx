...
export const metadata: Metadata = {
    ...
    description: `Kinesiólogo geriátrico a domicilio en Peñalolén. Tratamiento sarcopenia, prevención de caídas, artrosis y rehabilitación adulto mayor. Reembolso Isapre.`,
    keywords: [
