...
export const metadata: Metadata = {
    ...
    description: `Kine traumatológico a domicilio en Ñuñoa. Rehabilitación esguinces, fracturas, prótesis rodilla, lumbago y lesiones deportivas. Reembolso Isapre.`,
    keywords: [
