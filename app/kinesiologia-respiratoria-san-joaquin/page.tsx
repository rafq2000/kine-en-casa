...
export const metadata: Metadata = {
    ...
    description: `Kine respiratorio infantil y adulto a domicilio en San Joaquín. KTR bebés, bronquitis, neumonía, EPOC y rehabilitación post COVID. Reembolso Isapre.`,
    keywords: [
