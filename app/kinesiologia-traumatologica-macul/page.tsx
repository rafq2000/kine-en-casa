...
export const metadata: Metadata = {
    ...
    description: `Rehabilitación traumatológica a domicilio en Macul. Recupérese de esguinces, fracturas y lesiones deportivas sin salir de casa. Agende hoy al +56 9 9967 9593.`,
    keywords: [
