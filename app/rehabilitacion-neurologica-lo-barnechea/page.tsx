...
export const metadata: Metadata = {
    ...
    description:
        "Kinesiólogo a domicilio en Lo Barnechea para secuelas de ACV, Parkinson y esclerosis múltiple, con plan semanal en casa. Boleta reembolsable en tu Isapre.",
    keywords: [
