...
export const metadata: Metadata = {
    ...
    description: `Kinesiólogo a domicilio en La Florida. Rehabilitación post operatoria, respiratoria infantil, geriátrica y traumatológica. Isapre y Fonasa. Evaluación gratis.`,
    keywords: [
