...
export const metadata: Metadata = {
    ...
    description: `Recuperación postquirúrgica especializada a domicilio en Vitacura. Kinesiólogos expertos para una rehabilitación segura y efectiva. Agende hoy al +56 9 9967 9593.`,
    keywords: [
