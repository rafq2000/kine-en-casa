...
export const metadata: Metadata = {
    ...
    description: `Rehabilitación geriátrica para el adulto mayor a domicilio en Santiago Centro. Tratamiento de Sarcopenia, prevención de caídas y artrosis. Agende hoy al +56 9 9967 9593.`,
    keywords: [
