...
export const metadata: Metadata = {
    ...
    description: `Kinesiología respiratoria pediátrica y adulto a domicilio en Providencia. Tratamiento experto para bronquitis, neumonía, y EPOC. Agende hoy al +56 9 9967 9593.`,
    keywords: [
