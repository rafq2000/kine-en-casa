...
export const blogPosts = [
  ...
  },
  {
    ...
    content: `<p class="lead">Sí, puedes atenderte con kinesiólogo siendo de Fonasa, y también a domicilio. La clave se llama <strong>Modalidad Libre Elección (MLE)</strong>. Aquí te explicamos quiénes pueden usarla, cuánto cubre y el paso a paso exacto para no perder el beneficio.</p>
      ...
      <h2>Requisitos para usar Fonasa en kinesiología</h2>
      <ul>
      ...
      <p>El arancel MLE define un valor de referencia por sesión de kinesiterapia y Fonasa bonifica una parte; el resto es copago del paciente. Como referencia práctica en 2026, la bonificación cubre aproximadamente entre un 25% y un 50% del valor arancelado según tramo y prestación. Dos cosas importantes:</p>
      <ul>
      ...
      <p>Sí. La atención domiciliaria es compatible con MLE cuando el prestador está inscrito y la prestación corresponde a la orden médica.</p>
      <h3>¿Cuántas sesiones cubre Fonasa?</h3>
      <p>Las que indique tu orden médica. Si necesitas más, el médico puede emitir una nueva orden.</p>
      <h3>¿Qué pasa si soy tramo A?</h3>
      <p>Puedes atenderte igualmente de forma particular con nosotros; la evaluación inicial sigue siendo gratuita y tenemos <a href="/precios">planes con valor por sesión reducido</a>.</p>
  ...
  },
  {
    ...
    content: `<p class="lead">Un hombro más alto que otro, una escápula más prominente, el pantalón que "cae chueco". La escoliosis idiopática afecta al 2-3% de los adolescentes y su detección temprana define el pronóstico: detectada a tiempo, la mayoría se maneja sin cirugía.</p>
      ...
      <ul>
        <li>Asimetría visible de hombros, escápulas o cintura.</li>
        <li>Giba costal en el test de Adams.</li>
        <li>Antecedentes familiares de escoliosis (aumenta el riesgo).</li>
        <li>Dolor de espalda persistente en un niño SIEMPRE amerita evaluación (la escoliosis idiopática no suele doler; si duele, hay que estudiar).</li>
      </ul>
  ...
  },
  {
    ...
    content: `<p class="lead">"Necesito un masaje descontracturante" es probablemente la frase con la que más pacientes nos contactan. A veces es exactamente lo que necesitan. Otras veces, el masaje solo tapa por unos días un problema que requiere tratamiento de verdad. Te ayudamos a distinguir.</p>
      ...
      <ul>
        <li>¿Tensión difusa por estrés, sin dolor localizado ni irradiación? → Masaje de relajación es razonable.</li>
        <li>¿Dolor que se repite, limita, irradia o dura semanas? → Evaluación kinesiológica primero. Tratar sin evaluar es adivinar.</li>
      </ul>

      <blockquote>"Si llevas 3 masajes en 2 meses para el mismo dolor, no necesitas un cuarto masaje: necesitas un diagnóstico funcional."</blockquote>

      <p>En KINEUM la primera evaluación es <a href="/como-funciona">gratuita y a domicilio</a>: te decimos con honestidad si tu caso es de relajación o de tratamiento. <a href="https://wa.me/56999679593?text=Hola,%20tengo%20contracturas%20frecuentes">Escríbenos por WhatsApp</a>.</p>
    `
  },
  {
  ...
  },
  {
    ...
    content: `<p class="lead">La fibromialgia plantea una paradoja cruel: moverse duele, pero no moverse duele más. La evidencia es unánime en que el ejercicio dosificado es el tratamiento con mayor efecto sostenido sobre el dolor, el sueño y la calidad de vida. El secreto está en la dosis.</p>
      ...
      <h2>La estrategia: empezar ridículamente suave</h2>
