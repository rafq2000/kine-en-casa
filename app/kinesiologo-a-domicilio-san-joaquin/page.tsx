...
export const metadata: Metadata = {
    ...
    description: `Kinesiólogo a domicilio en San Joaquín. Kinesiología respiratoria, geriátrica, traumatológica y rehabilitación neurológica. Isapre y Fonasa. Evaluación gratis.`,
    keywords: [
